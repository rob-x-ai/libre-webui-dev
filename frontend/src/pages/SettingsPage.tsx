...
import { Settings, Monitor, Palette, MessageSquare, Cpu, Database } from 'lucide-react';
...
export const SettingsPage: React.FC = () => {
  ...
  const [tempSystemMessage, setTempSystemMessage] = useState(preferences.systemMessage);
            ...
            <div className="space-y-4">
              <div>
                ...
                <Select
                  ...
                  onChange={(e) => handleUpdatePreferences({ defaultModel: e.target.value })}
                  options={[
                ...
                {models.length === 0 && (
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    No models available. Please download models from the Models page.
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="flex items-center justify-between mt-2">
                  ...
                  <Button
                    ...
                    size="sm"
                    disabled={loading || tempSystemMessage === preferences.systemMessage}
                  >
                    Save
                  </Button>
                </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
            ...
            <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
              ...
              <p className="pt-2 border-t border-gray-200 dark:border-gray-700">
                <em>"Like Rick Rubin strips music to its essence, Libre WebUI strips away UI complexity. Simple. Minimal. Effective."</em>
              </p>
            </div>
          </div>
        </div>
