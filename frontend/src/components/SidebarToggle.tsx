...
export const SidebarToggle: React.FC<SidebarToggleProps> = ({ className }) => {
  ...
  return (
    <Button
      ...
      className={cn(
        'fixed top-1/2 -translate-y-1/2 z-50 h-12 w-6 p-0 rounded-r-lg rounded-l-none bg-white dark:bg-dark-50 border border-gray-200 dark:border-dark-200 border-l-0 shadow-lg hover:bg-gray-50 dark:hover:bg-dark-100 transition-all duration-300 ease-in-out hover:w-7 group',
